                ...
                <div class="box-body">
                    <form action="" method="post" data-ajax="true" data-redirect-url="<?= $this->Html->url('/admin/stats') ?>">
                        <div class="form-group">
                            ...
                            <input name="name" type="text" class="form-control" placeholder="<?= $Lang->get('STATS__RANK_EXEMPLE') ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="level" type="text" class="form-control" placeholder="<?= $Lang->get('STATS__RANK_NUMBER_EXEMPLE') ?>">
                        </div>
                        <div class="form-group">
                            <label><?= $Lang->get('STATS__RANK_DESC') ?></label>
                            <input name="desc" type="text" class="form-control" placeholder="<?= $Lang->get('STATS__RANK_DESC_EXEMPLE') ?>">
                        </div>
